...
os.system("$ROSETTA3/rna_denovo.default.macosclangrelease -fasta aptamer.txt -nstruct 1 -minimize_rna -secstruct_file aptamer_sec.txt -out::file::silent my_rna_structures.out")
